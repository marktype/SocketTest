...
public class LogsUtil {
    ...
    public static void i(Context context, String msg){
        if (isOpen){
            Log.i(packageName,getClassName(context)+"----"+msg);
        }
    }
    public static void w(Context context, String msg){
        if (isOpen){
            Log.w(packageName,getClassName(context)+"----"+msg);
        }
    }
    public static void e(Context context, String msg){
        if (isOpen){
            Log.e(packageName,getClassName(context)+"----"+msg);
        }
    }
    ...
    public static void i(Fragment fragment, String msg){
        if (isOpen){
            Log.i(packageName,getFragmentName(fragment)+"----"+msg);
        }
    }
    public static void w(Fragment fragment, String msg){
        if (isOpen){
            Log.w(packageName,getFragmentName(fragment)+"----"+msg);
        }
    }
    public static void e(Fragment fragment, String msg){
        if (isOpen){
            Log.e(packageName,getFragmentName(fragment)+"----"+msg);
        }
    }
}
